...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> getBookingFromId(
            long userId, Long bookingId) {
        return get("/" + bookingId, userId);
    }

    public ResponseEntity<Object> getUserBookingsWithStatus(long userId, BookingState state, Integer from, Integer size) {
